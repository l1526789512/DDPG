...
class Actor(object):
    def __init__(self, sess, S, S_,action_dim, learning_rate, replacement, state_dim):
        self.sess = sess
...
class Critic(object):
    def __init__(self,sess, S, S_,R, state_dim, action_dim, learning_rate, gamma, replacement, a, a_):
        ...
        with tf.variable_scope('Critic'):
            ...
            self.q_ = self._build_net(self.S_, a_, 'target_net', trainable=False)
...
class Agent(object):
    def __init__(self,sess, action_dim, learning_rate_a,learning_rate_c, replacement, state_dim,gamma,buffer_cap):
        ...
        self.actor = Actor(sess, self.S,self.S_,action_dim, learning_rate_a, replacement, state_dim)
